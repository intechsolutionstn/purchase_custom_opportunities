...
class SaleOrdercollection(models.Model):
    ...
    def action_view_collections(self):
        action = self.env.ref('cash_on_delivery_odoo_av.action_cod_collection_tree').read()[0]
...
class website(models.Model):
    ...
    def get_cod_conf(self):
        cod_conf_obj = self.env['ir.model.data'].xmlid_to_object('cash_on_delivery_odoo_av.payment_acquirer_cod')
